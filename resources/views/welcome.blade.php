    ...
    <div class="container">
            ...
            <div class="properties__button">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Price high to low</a>
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="row">
                    <div class="col-md-6 offset-3">
                        {{$productByPrice->fragment('nav-home')->links("pagination::bootstrap-4")}}
                    </div>
                </div>
            </div>
            <!-- Card two -->
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                ...
                <div class="row">
                    <div class="col-md-6 offset-3">
                        {{$productByPrice->fragment('nav-profile')->links("pagination::bootstrap-4")}}
                    </div>
                </div>
            </div>
            <!-- Card three -->
